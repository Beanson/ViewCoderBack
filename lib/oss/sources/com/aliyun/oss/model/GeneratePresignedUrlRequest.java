...
public class GeneratePresignedUrlRequest {
     ...
     * </p>
     * <p>
     * OSS uses x-common-meta- as the prefix in the http headers to transfer the user's customized metadata.
    ...
    /**
     * Gets user's customized metadata. They will be represented in x-common-meta* headers.
     * @param userMetadata
     *          User's metadata
     */
     ...
     * @param key
     *          The metadata key.
     *          Note: this key should not have prefix of 'x-common-meta-'.
     * @param value
