...
public class ObjectMetadata {
    ...
    // The user's custom metadata, whose prefix in http header is x-common-meta-.
     ...
     * </p>
     * <p>
     * The custom metadata would be appended with x-common-meta- in the request to OSS.
     * But here the caller should not use x-common-meta- as the prefix for the keys of the Map instance returned.
     ...
     * @param key
     *          Key of the header (not starting with x-common-meta-)
     * @param value
