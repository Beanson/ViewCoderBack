...
public class HttpUploadServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    private static final HttpDataFactory factory =
            new DefaultHttpDataFactory(DefaultHttpDataFactory.MINSIZE); // insert to Disk if size exceed
    ...
    public void channelRead0(ChannelHandlerContext ctx, HttpObject msg) throws Exception {
        if (msg instanceof HttpRequest) {
            ...
            /** begin to decode post request data
             *  开始解析post的数据
             */
            try {
    ...
    /**
     * write the key information of the upload data embedded to website
     * 嵌入网页中展示上传文件的信息
     * @param data
     */
    private void writeHttpData(InterfaceHttpData data) {
        if (data.getHttpDataType() == HttpDataType.Attribute) {
            ...
            responseContent.append("\r\nBODY FileUpload: " + data.getHttpDataType().name() + " and data: " + data
                    + "and the end data\r\n");
    ...
    /**
     * response the uploaded file message
     * 返回上传的文件的信息，展示在页面端
     * @param channel
     */
    ...
    /**
     * write open website and show this
     * 打开网页访问8080端口访问此处
     */
    private void writeMenu(ChannelHandlerContext ctx) {
        ...
        responseContent.append("<title>Netty TestUtil Form</title>\r\n");
        responseContent.append("</head>\r\n");
        ...
        responseContent.append("<h1>Netty TestUtil Form</h1>");
