...
import FrontEnd.psd.parse.PsdChannelInfo;
import FrontEnd.psd.parse.PsdInputStream;
import FrontEnd.psd.parse.PsdTextLayerTypeTool;
...
public class PsdLayer {
    ...
    public String toString() {
        return "Layer: id=" + layerId + " key=" + key + " name=" + name + " left=" + left + " top=" + top + " width:" + width + " height:" + height
                + " visible=" + visible + " opacity:" + opacity + " clipping=" + clipping + " [group=" + parent + "]";
    }
    ...
    private String EnginData;

    /***
     * set the engine data for later access
     * @param str the engindata
     */
    private void setEngineData(String str) {
        //System.out.println("enter---------------------------------------"+str);
        EnginData = str;
    }

    /**
     * return EngineData for parsing font style
     *
     * @return string containing font style info
     */
    ...
    private void readExtraData(PsdInputStream stream) throws IOException,
        ...
        name = new String(str, 0, strSize, "GBK");
        ...
        while (stream.getPos() - extraPos < extraSize) {
            ...
            if (tag.equals("lyid")) {
                ...
                setEngineData(typeTool.get("EngineData").toString());
                setFontText(typeTool.get("Txt ").toString());
            } else {
    ...
    private void readLayerSectionDevider(PsdInputStream stream)
        ...
        logger.warning("come into lsct and the type is: " + dividerType);
        switch (dividerType) {
            case 1:
            case 2:
